...
class TestMakeRequest:
    ...
    def test_make_request_preserves_api_prefix(self, client):
        ...
        with requests_mock.Mocker() as m:
            m.get('http://test-sonarr:8989/api/v3/system/status', json={}, status_code=200)
    ...
    def test_make_request_http_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            m.get('http://test-sonarr:8989/api/v3/test', 
...
class TestQueue:
    ...
    def test_remove_from_queue_success(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            result = client.remove_from_queue(1, remove_from_client=True, blocklist=False)
            assert result is True
    
    def test_remove_from_queue_error(self, client):
        """Test queue item removal error handling"""
        with requests_mock.Mocker() as m:
            m.delete('http://test-sonarr:8989/api/v3/queue/1', 
                     exc=requests.ConnectionError)
...
class TestEpisodeOperations:
    ...
    def test_get_episode_info_not_found(self, client):
        ...
        with requests_mock.Mocker() as m:
            m.get('http://test-sonarr:8989/api/v3/episode', 
    ...
    def test_get_episode_file_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            m.get('http://test-sonarr:8989/api/v3/episodefile/50', 
                  status_code=404)
