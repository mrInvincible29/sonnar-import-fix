...
def mock_config():
    ...
    return {
        ...
        "decisions": {"force_import_threshold": 10, "remove_stuck_threshold_hours": 24},
        "trackers": {
...
def mock_sonarr_queue_item():
    ...
    return {
        ...
        "indexer": "TestTracker",
        "quality": {"quality": {"id": 6, "name": "720p HDTV"}, "customFormats": []},
    }
...
def sample_webhook_payload():
    ...
    return {
        "eventType": "Grab",
        "series": {"id": 10, "title": "Test Series", "path": "/data/tv/Test Series"},
        "episodes": [
            {"id": 100, "title": "Test Episode", "seasonNumber": 1, "episodeNumber": 1}
        ],
        "release": {
            "quality": "HDTV-720p",
