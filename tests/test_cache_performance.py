...
class TestCachePerformanceBenchmarks:
    ...
    def test_large_dataset_performance(self):
        ...
        import random
        access_keys = [f"large_key_{random.randint(0, dataset_size-1)}" for _ in range(1000)]
    ...
    def test_concurrent_performance(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
            read_futures = [
                executor.submit(worker_read, thread_id, 100)
                for thread_id in range(5)
            ]
            write_futures = [
...
class TestSonarrClientPerformance:
    ...
    def test_api_call_reduction(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            assert total_cached_time < total_non_cached_time / 2  # Significant time savings
    ...
    def test_custom_format_scores_caching_performance(self, client):
        ...
        with patch.object(client, 'get_custom_format_scores') as mock_scores:
            ...
            print(f"Cache hit ratio: {1 - (mock_scores.call_count / len(series_ids)):.2%}")
...
class TestRealWorldScenarios:
    ...
    def test_batch_series_analysis(self, client):
        ...
        with patch.object(client, 'get_custom_format_scores') as mock_scores:
            ...
            print(f"Performance improvement: {expected_time_without_cache / total_time:.1f}x")
