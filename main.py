...
Environment Variables:
  ...
  LOG_LEVEL           - Logging level (DEBUG, INFO, WARNING, ERROR)
    ...
    parser.add_argument(
        "--config", "-c", help="Path to YAML configuration file (default: config.yaml)"
    )

    parser.add_argument("--env", help="Path to environment file (default: .env)")
...
def main():
    ...
    try:
        ...
        logger.info(
            f"   Configuration loaded from: {args.config or 'default locations'}"
        )
