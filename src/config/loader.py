...
class ConfigLoader:
    ...
    SENSITIVE_KEYS = ['api_key', 'webhook_secret', 'password', 'token', 'key']
...
DEFAULT_CONFIG = {
    ...
    'trackers': {
        'private': [
            'beyondhd', 'bhd', 'privatehd', 'passthepopcorn', 'ptp',
            'broadcasthenet', 'btn', 'redacted', 'orpheus'
        ],
        'public': [
            'nyaa', 'animetosho', 'rarbg', '1337x', 'thepiratebay',
